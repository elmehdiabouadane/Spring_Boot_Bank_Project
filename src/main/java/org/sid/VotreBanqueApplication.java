...
public class VotreBanqueApplication implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		/*Client c1 = clientRepository.save(new Client("El Mehdi","mehdi.abouadane96@gmail.com"));
		Client c2 = clientRepository.save(new Client("Haitam","haitam@gmail.com"));
		...
		String e = new BCryptPasswordEncoder().encode("1234");
